...
export default function UserEnquiryPending2() {
        ...
        >
          ...
          >
            ...
            <Button
              variant="contained"
              sx={{
                width: { xs: "100%", sm: "auto" }, // Full width on small screens, auto on larger ones
                height: "50px",
                backgroundColor: "blue", // Set background color to blue
                color: "white", // Set text color to white
                "&:hover": {
                  textDecoration: "underline", // Add underline text decoration on hover
                },
              }}
            >
              Search
